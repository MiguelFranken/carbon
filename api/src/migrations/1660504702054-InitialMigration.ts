...
export class InitialMigration1660504702054 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE `trait` (`id` int NOT NULL AUTO_INCREMENT, `size` varchar(255) NULL, `top` tinyint NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
    );
    await queryRunner.query(
      "CREATE TABLE `token` (`id` int NOT NULL, `size` int NOT NULL DEFAULT '1', `balance` decimal(65,0) NOT NULL DEFAULT '0', `blockNumber` int NULL, `timestamp` timestamp NOT NULL, `traitId` int NULL, UNIQUE INDEX `REL_6212487f5bf91cfba6c69ae635` (`traitId`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
    );
    await queryRunner.query(
